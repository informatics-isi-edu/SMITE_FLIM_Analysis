...
% Additional settings:
NADH_thresh_val  =  7;                % Threshold value for NADH in phasor analysis.
...
%% Output data folder
DataTable=table(Name,z_num,effective_pixel_count, G_sum, S_sum, Free_LEXT,G_int,S_int,tao,Free_LR);
